...
function Contact() {
  return (
    <div className="container mt-5 pt-5" style={{ width: "80%" }}>
      ...
      <div>
        <h6 className="MsoNormal">Q: Is there a retrieve fee?</h6>
        <p>
          A: in retrieving a product in its original condition (not damaged),
          the retrieve fee will be paid by the customer and it is 19 SR. It will
          be deducted from the retrieved product’s price. In retrieving a
          damaged product, NICEONE will pay all fees.
        </p>
        <h6 className="MsoNormal">Q: Is there a retrieve fee?</h6>
        <p>
